...
#define RENDERER_NAME_KRYPTON_WRAPPER "libng_gl4es.dylib"
#define RENDERER_NAME_METALCRAFT_BACKEND RENDERER_NAME_METALCRAFT
#define RENDERER_NAME_METALCRAFT_BOOTSTRAP RENDERER_NAME_KRYPTON_WRAPPER
